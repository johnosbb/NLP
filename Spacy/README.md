...
The nonfiinite verb phrase has been outlined in bold in the examples above.

Agaiin, it can be difficult to distinguish between a direct object,indirect object,object compliment and a nonfiinite verb phrase. We can normally clarify the situation by substituting the phrase with __something__. If we can replace the phrase with "__something__" then we can assume that the phrase is acting as a nominal.
