...
sample_sentences = [
    {"example": "The boy has walked to the school and has eaten his lunch.", "classification": "", "comments": ""},
    {"example": "The cat and the dog are playful, and the bird is singing on the tree.", "classification": "", "comments": ""},
    {"example": "The red car sped down the highway.", "classification": "", "comments": ""},
...
def find_clauses(sentence: Doc):
    ...
    report(f"Sentence: {sentence.text}")
    ...
    if(len(clauses) > 0):
        ...
        for clause in clauses:
            report(f"\t{clause_number}: {clause} Type : {clause.type}")
